...
class StyleResources{
  ...
  static TextStyle title(BuildContext context){
    return Theme.of(context).textTheme.title.copyWith(color: ColorResources.primaryColor);
  }
  ...
  static TextStyle dialogHeader(BuildContext context){
    return Theme.of(context).textTheme.headline.copyWith(fontWeight: FontWeight.bold,color: ColorResources.primaryColor);
  }

  static TextStyle dialogContent(BuildContext context){
    return Theme.of(context).textTheme.body2.copyWith(color: ColorResources.primaryColor);
  }
}