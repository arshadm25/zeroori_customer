...
//        ),
  ...
  _generateNoOfferPage(){
    return Column(
      ...
      children: <Widget>[
        Center(child: Icon(Icons.comment,size: 50,color: ColorResources.primaryColor,)),
        SizedBox(height:10),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal:24.0),
          child: Text("No Offers Selected",textAlign:TextAlign.center,maxLines: 2,style: TextStyle(
            color: Colors.black,
            fontSize: 30,
        ...
        Padding(
          padding: const EdgeInsets.symmetric(horizontal:24.0),
          child: Text("Favourite Offers you like to compare it later to select the best one",textAlign:TextAlign.center,maxLines: 3,style: TextStyle(
            color: Colors.black,
            fontSize: 25,
